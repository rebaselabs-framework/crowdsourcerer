...
# ``/stream`` lives in routers/tasks_streams.py — see the trailing
# ``from routers import tasks_streams`` at the bottom of this file.
...
# SSE /{task_id}/status-stream and /{task_id}/output-stream live in
# routers/tasks_streams.py — see the trailing import at the bottom of
# this file.
...
# ─── Split modules ────────────────────────────────────────────────────────
# Importing submodules at the bottom of the file (after ``router`` has been
# defined above) registers their routes onto the same APIRouter instance.
# The ``noqa: E402,F401`` is intentional — this is a side-effect import by
# design, not a dead symbol.
from routers import tasks_streams  # noqa: E402,F401
