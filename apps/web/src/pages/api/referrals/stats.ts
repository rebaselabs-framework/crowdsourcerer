/**
 * GET /api/referrals/stats — proxy to GET /v1/referrals/stats
 *
 * Returns the caller's referral code, shareable URL, and bonus credit totals.
...
export const GET: APIRoute = async ({ cookies }) => {
  ...
  try {
    const res = await fetch(`${API_URL}/v1/referrals/stats`, {
