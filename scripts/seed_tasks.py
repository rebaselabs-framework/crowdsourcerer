...
TASKS = [
    ...
    # === CATEGORIZE ITEMS ===
    {
        ...
        "title": "Categorize startup by industry",
        "instructions": "Read the startup description and select the most appropriate industry category.",
        "input": {"name": "NeuralChef", "description": "AI-powered meal planning app that learns your dietary preferences, suggests recipes based on ingredients you have, and generates shopping lists. Integrates with grocery delivery."},
        "labels": ["FoodTech", "HealthTech", "AI/ML", "E-commerce", "SaaS", "FinTech", "EdTech"],
        "priority": "normal",
        "worker_reward_credits": 5,
        "assignments_required": 3,
    },
    {
        ...
        "title": "Categorize startup by industry",
        "instructions": "Read the startup description and select the most appropriate industry category.",
        "input": {"name": "PayBridge", "description": "Cross-border payment platform for freelancers. Converts payments between 40+ currencies with near-zero fees using blockchain settlement."},
        "labels": ["FoodTech", "HealthTech", "AI/ML", "E-commerce", "SaaS", "FinTech", "EdTech"],
        "priority": "normal",
        "worker_reward_credits": 5,
        "assignments_required": 3,
    },
    {
        ...
        "title": "Categorize startup by industry",
        "instructions": "Read the startup description and select the most appropriate industry category.",
        "input": {"name": "SkillForge", "description": "Adaptive learning platform that uses AI to create personalized coding curricula. Tracks skill gaps and adjusts difficulty in real-time. Built for bootcamp graduates transitioning to senior roles."},
        "labels": ["FoodTech", "HealthTech", "AI/ML", "E-commerce", "SaaS", "FinTech", "EdTech"],
        "priority": "normal",
        "worker_reward_credits": 5,
        "assignments_required": 3,
